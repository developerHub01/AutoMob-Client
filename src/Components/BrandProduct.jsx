...
const BrandProduct = ({
  ...
  return (
    <div className="w-full shadow-xl cursor-pointer">
      <figure className="w-full md:h-72 lg:h-52 relative bg-gray-900">
        <p className="capitalize absolute inline-block top-2 right-2 px-2 py-1 rounded-full bg-gray-900 text-white z-10 text-sm">
          {brandName}
        </p>
        <img
          src={productImg}
      ...
      <div className="p-5 flex flex-col justify-center items-start gap-2">
        <h3 className="capitalize text-2xl font-semibold text-gray-900">
          {name}
        </h3>
        <p className="text-gray-600 font-medium text-lg">${price}</p>
        <Rating rating={rating} />
        <div className="w-full flex-wrap flex justify-between items-center gap-2">
